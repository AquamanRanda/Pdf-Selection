...
viewerElement.addEventListener('ready', function() {
  ...
  viewerWindow.document.body.addEventListener('drop', function(e) {
    var scrollElement = viewerWindow.docViewer.getScrollViewElement();
...
addElement.addEventListener('dragstart', function(e) {
  ...
  var copy = e.target.cloneNode(false);
  copy.id = 'form-build-drag-image-copy';
  var isCheckBox = document.getElementById('fieldType').value === 'check';
